...
def main():
    ...
    datos["MntFishProducts"] = st.number_input("Gasto en pescado", min_value=0, max_value=10000, value=120)
    datos["MntSweetProducts"] = st.number_input("Gasto en dulces", min_value=0, max_value=10000, value=120)
    ...
    datos["NumWebPurchases"] = st.number_input("Número de compras por web", min_value=0, max_value=100, value=3)
    datos["NumCatalogPurchases"] = st.number_input("Número de compras por catálogo", min_value=0, max_value=100, value=3)
    datos["NumStorePurchases"] = st.number_input("Número de compras en tienda física", min_value=0, max_value=100, value=2)
    datos["NumWebVisitsMonth"] = st.number_input("Número de visitas web al mes", min_value=0, max_value=100, value=3)
